...
public abstract class RatioAbstractService {
    private final ProcessedOntologyRepository processedOntologyRepository;

    protected RatioAbstractService(ProcessedOntologyRepository processedOntologyRepository) {
        this.processedOntologyRepository = processedOntologyRepository;
    }

    protected abstract List<Set<String>> getCharacteristics(List<ProcessedOntology> processedOntologies);
    ...
    public <T extends Ontology> double getRatio(List<T> ontologies) {
        ...
        List<Set<String>> characteristics = getCharacteristics(processedOntologies);
