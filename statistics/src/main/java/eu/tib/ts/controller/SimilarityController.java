...
public class SimilarityController {
    ...
    @Operation(summary = "Similarity measure between TS internal ontologies " +
    ...
    @Operation(summary = "Similarity measure between given TS internal ontology" +
    ...
    public ResponseEntity<PagedModel<SimilarityModel>> getSimilarityForInternalOntology(
        @Parameter(description = "Characteristics to be compared by", example = "PROPERTY")
        @PathVariable("characteristics") CharacteristicsType characteristicsType,
        @Parameter(description = "A given Ontology ID managed in the TS", example = "swo")
    ...
    @Operation(summary = "Similarity measure for external ontology " +
        "by calculating shared Properties | Classes | Imports | Namespaces")
    ...
    public ResponseEntity<PagedModel<SimilarityModel>> getSimilarityForExternalOntology(
        @Parameter(description = "Characteristics to be compared by", example = "PROPERTY")
        @PathVariable("characteristics") CharacteristicsType characteristicsType,
        @Parameter(description = "External ontology URL")
    ...
    @Operation(summary = "Pairwise similarity between TS internal ontologies")
    ...
    @Operation(summary = "Pairwise similarity between given TS internal ontology " +
    ...
    public ResponseEntity<PagedModel<PairwiseSimilarityModel>> getPairwiseSimilarityForInternalOntology(
        @Parameter(description = "A given Ontology ID managed in the TS", example = "dicl")
        @RequestParam String id,
        @Parameter(description = "Collection to filter set of ontologies", example = "NFDI4ING")
        @RequestParam(required = false) Optional<String> collection,
        Pageable pageable
    ...
    @Operation(summary = "Pairwise similarity for external ontology")
